...
Tenant.run_on_each do
  SitemapGenerator::Sitemap.default_host = root_url(ApplicationMailer.new.default_url_options)

  if Tenant.default?
    SitemapGenerator::Sitemap.sitemaps_path = nil
  else
    SitemapGenerator::Sitemap.sitemaps_path = "sitemaps/#{Tenant.current_subdomain}"
  end
